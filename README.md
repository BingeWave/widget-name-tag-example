...
## Focus Of This Code
The focus of this tutorial is how to put a name tag on screen of the user based on the current users screen. This code sample is a good basic example of using the participant properties. The following material is available as references to further understand the concepts and tools used:
